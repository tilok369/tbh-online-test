...
{
    public partial class OnlineTestDevContext : DbContext
    {
        public OnlineTestDevContext()
        {
        }

        public OnlineTestDevContext(DbContextOptions<OnlineTestDevContext> options)
            : base(options)
        {
        }
